...
def feature_engineering(data):
    ...
    # Delivery Stress Score: Combines traffic and weather severity to capture delay impact
    # Higher values indicate difficult delivery conditions (e.g., heavy traffic + bad weather)
